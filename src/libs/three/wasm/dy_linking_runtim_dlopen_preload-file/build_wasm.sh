...
~/develop/emscripten-main/emcc -sMAIN_MODULE=2 ./main.cpp liba.so  -o dynLink.wasm.js -mnontrapping-fptoint -sEXPORT_ES6=1  -sEXPORTED_RUNTIME_METHODS=ccall,cwrap,getValue,setValue --pre-js=pre.js  --preload-file .@/ --use-preload-plugins  -sENVIRONMENT=web -sINITIAL_MEMORY=52428800  #  -L./ -la  -sALLOW_MEMORY_GROWTH=1   --embed-file .


# sed [opstions] "addresscommand...[flags]" filename
sed -ir 's/, packageName/, "\/static\/dy_linking_runtim_dlopen_preload-file\/" + packageName/g' dynLink.wasm.js

cp ./dynLink.wasm.data ../../../../../static/dy_linking_runtim_dlopen_preload-file
cp ./liba.so ../../../../../static/dy_linking_runtim_dlopen_preload-file
cp ./dynLink.wasm.js ../../../../../static/dy_linking_runtim_dlopen_preload-file
cp ./dynLink.wasm.wasm ../../../../../static/dy_linking_runtim_dlopen_preload-file
