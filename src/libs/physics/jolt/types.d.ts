...
declare module Jolt {
    ...
    class PhysicsStepListenerJS extends PhysicsStepListener {
        constructor();
        OnStep(inDeltaTime: number, inSystem: number): void;
    }
    ...
    class VehicleConstraintCallbacksJS extends VehicleConstraintCallbacksEm {
        ...
        OnPreStepCallback(inVehicle: number, inDeltaTime: number, inPhysicsSystem: number): void;
        OnPostCollideCallback(inVehicle: number, inDeltaTime: number, inPhysicsSystem: number): void;
        OnPostStepCallback(inVehicle: number, inDeltaTime: number, inPhysicsSystem: number): void;
    }
